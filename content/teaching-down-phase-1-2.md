---
title: Teaching Down - Phase 1-2 (Introduce Lure & Build Speed)
permalink: /watermelon/teaching-down-phase-1-2/
updated: 2025-11-22T19:59
---

## Phase 1-2: Introduce Lure & Build Speed

**Timeline:** Days 1-8 (1-8 days total)

**Goal:** Get Melon to follow the lure into a down position and build speed/reliability. By the end of Phase 2, she's dropping into a down within 3 seconds.
...
- 10-15 reps per session (Phase 1), 15-20 reps per session (Phase 2)
...
This is critical - get the path right and everything else is easy.
...
- Increase reps to 15-20 per session
- Start varying her starting position (standing, sitting, facing different directions)
- Make your lure motion faster
- Give multiple treats in a row
